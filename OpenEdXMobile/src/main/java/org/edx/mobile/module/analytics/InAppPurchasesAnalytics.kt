...
class InAppPurchasesAnalytics @Inject constructor(
    ...
    fun initCourseValues(
        ...
        this.localizedPrice = 0.0
        this.lmsUsdPrice = lmsUsdPrice
    ...
    fun setPrice(price: Double, currencyCode: String) {
        this.localizedPrice = price
        this.localizedCurrencyCode = currencyCode
    }
